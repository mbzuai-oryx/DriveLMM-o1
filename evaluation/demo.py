...
def load_image_dynamic(image_file, input_size=448, max_num=12):
...
pixel_values = load_image('./multiview/0c601ff2bf004fccafec366b08bf29e2_1e8b732e51b849a484f642c387b75c1b.png').to(torch.bfloat16).cuda()
generation_config = dict(max_new_tokens=1024, do_sample=False)

# single-image single-round conversation (单图单轮对话)
question = '<image>\nDescribe the 3 most important objects in the current scene that the ego vehicle must take into consideration.'
